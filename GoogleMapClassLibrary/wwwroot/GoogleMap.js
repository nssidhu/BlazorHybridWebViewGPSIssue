...
export async function initGoogleMap(mapdivElement, blazorPageRef, errorDisplayElementID) {
    'use strict';
    ...
    try {
           ...
           //loadscript has logic to prevent duplicate loads
            await loadScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyC8uZQso05nCFFrLMAMjNIqvJeykBZoaYM&libraries=geometry').then(() => {
